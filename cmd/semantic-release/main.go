...
import (
	...
	"flag"
	"fmt"
	"github.com/go-semantic-release/go-semantic-release"
	"github.com/go-semantic-release/go-semantic-release/condition"
	"github.com/go-semantic-release/go-semantic-release/update"
	"io/ioutil"
	"log"
	"os"
	"strings"
